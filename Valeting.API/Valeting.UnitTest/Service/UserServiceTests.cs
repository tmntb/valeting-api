...
public class AuthenticationServiceTests
{
    ...
    public async Task GenerateToken_ValidUser_ReturnsTokenAsync()
    {
        ...
        userRepositoryMock.Setup(r => r.FindUserByEmailAsync(generateTokenJWTSVRequest.Username)).ReturnsAsync(userDTO_DB);
        ...
        // Act
        var result = await userService.GenerateTokenJWTAsync(generateTokenJWTSVRequest);
    ...
    public async Task GenerateToken_UserNotFound_ReturnsError()
    {
        ...
        userRepositoryMock.Setup(r => r.FindUserByEmailAsync(generateTokenJWTSVRequest.Username)).ReturnsAsync((UserDTO)null);
